...
public protocol LPromptViewDelegate: class {
    
    func promptViewButtonClick(_ view: LPromptView)
    
    func promptViewImageClick(_ view: LPromptView)
}

public extension LPromptViewDelegate {
...
public class LPromptView: UIView {
